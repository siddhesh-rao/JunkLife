    ...
    <footer className="mt-16 border-t border-brand-100 bg-brand-950 text-brand-50">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-3 lg:px-8">
        <div>
          ...
          <p className="mt-3 text-sm text-brand-100">Sustainable scrap pickup for homes, apartments, and workplaces across Delhi NCR.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-brand-100">siddheshrao123@gmail.com</p>
